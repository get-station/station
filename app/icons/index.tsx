...
const ICONS = [
    ...
    },
    {
        id: 'Arc',
        label: 'Arc',
        image: require('@/assets/icon-arc.png'),
    },
    {
        id: 'Text',
        label: 'Text',
        image: require('@/assets/icon-text.png'),
    },
    {
        id: 'Door',
        label: 'Door',
        image: require('@/assets/icon-door.png'),
    },
] as const
                ...
                {ICONS.map((icon, index) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            {isSelected && (
                                <Ionicons name="checkmark" size={24} color={COLORS.pink500} />
                            )}
                        </TouchableOpacity>
                    )
                })}
